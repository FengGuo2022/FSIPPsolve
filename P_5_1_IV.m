...
%           (2) unit sphere
%           (3) unit ball
%           (4) polytope define by Ay<=b (if latte is installed)
%
...
prob.p=-1+2*x(1)^2+2*x(2)^2-(y(1)-y(2))^2*x(1)*x(2);
%==========================================================================
...
%   'sphere'; 
%   'ball'; 
%   'polytope' (if latte is installed)
prob.indset='polytope'; 
%==========================================================================
